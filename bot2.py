...
async def get_start(message: types.Message):
    ...
    await bot.send_sticker(message.chat.id , 'CAACAgIAAxkBAAEFTGNi1AtnXOAg9K_H8E1XA7gkiYcWPwAClhYAAuoBIUith6voGqSVMikE')
...
async def profile(message: types.Message):
    if message.text == '👤 Профиль':
        await bot.send_sticker(message.chat.id, 'CAACAgIAAxkBAAEFWe9i2_J2g4xDVAwulvCDwawWlnVRXAACfRQAAkm1IUjehEBphgJn4ykE')
    ...
    if message.text == 'ℹ️ О нас':
        await bot.send_sticker(message.chat.id, 'CAACAgIAAxkBAAEFWyhi3BxPcDt0ejSFzhnSt3izrNzsegACHhUAAjtioEv8X3TJ_pl4rSkE')
